...
namespace X.TryATry.Test.Model
{
	...
	public class CREDIT_DEBTSTATISTIC
	{
        ...
        private decimal _loantotal = decimal.MinValue;
        private decimal _loanleave = decimal.MinValue;
        private decimal _loan6monthavg = decimal.MinValue;
        private decimal _creditcardtotal = decimal.MinValue;
        private decimal _singlecardmax = decimal.MinValue;
        private decimal _singlecardmin = decimal.MinValue;
        private decimal _creditcarduse = decimal.MinValue;
        private decimal _card6monthavg = decimal.MinValue;
        #endregion
